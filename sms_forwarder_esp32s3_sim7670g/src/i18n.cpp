...
static const I18nEntry I18N_TABLE[] = {
  ...
  {"data_cid_busy_retry_detach", "CGACT\u65ad\u5f00\u88abCID\u5360\u7528\u963b\u6b62, \u5c1d\u8bd5\u76f4\u63a5\u6267\u884cCGATT=0: %s", "CGACT deactivation blocked by active CID, retrying with CGATT=0: %s"},
  ...
  {"sms_invalid_index", "\u77ed\u4fe1\u7d22\u5f15\u65e0\u6548\uff0c\u5c06\u91cd\u65b0\u626b\u63cf", "Invalid SMS index; scheduling a full scan"},
  {"sms_list_found", "\u53d1\u73b0\u77ed\u4fe1: %s", "SMS found: %s"},
  {"sms_manual_check_start", "\u5f00\u59cb\u624b\u52a8\u67e5\u8be2\u6240\u6709\u77ed\u4fe1", "Manual check all SMS"},
  {"sms_manual_cmgr_start", "\u5f00\u59cbCMGR\u8f6e\u8be2, \u4ece\u7d22\u5f150\u5230%s", "Start CMGR polling, index 0-%s"},
  ...
  {"sms_send_no_service_detail", "\u65e0\u7f51\u7edc\u670d\u52a1\uff0c\u53d6\u6d88\u53d1\u9001: %s", "No network service, cancel sending: %s"},
  ...
  {"sms_send_registration", "\u53d1\u9001\u524d\u7f51\u7edc\u6ce8\u518c: %s", "SMS preflight registration: %s"},
