...
const String& getBootstrapWebPassword() { static String password = "test-device-bootstrap-password"; return password; }
Config config;
...
int main() {
  for (int failure = 0; failure < 4; failure++) {
    ...
    setDefaultConfig();
    assert(config.webAuth.enabled && !config.webAuth.password.isEmpty());
